        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-500 text-white">
            <div className="container mx-auto px-6 py-6 max-w-7xl">
                <header className="flex justify-between items-center py-4 mb-8 ">
                    <div className="font-bold text-2xl bg-clip-text">
                        biarnyadar.
                    </div>
                </header>
                ...
                <section className="py-12 md:py-16 text-center">
                    ...
                    <div className="mt-8 p-6 bg-gradient-to-r from-blue-900/20 to-gray-500/20 rounded-2xl backdrop-blur-sm shadow-lg">
                        <p className="text-lg leading-relaxed">
                            biarnyadar.com is an AI-powered web application that
                            ...
                            touch of sarcastic roasting, this app makes users
                            aware of their unhealthy choices in a fun yet
                            effective way.
                        </p>
                    </div>
                </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex items-start mr-6 bg-gradient-to-r from-blue-900/20 to-gray-500/20 rounded-2xl backdrop-blur-sm shadow-lg p-6">
                            ...
                            <div>
                                ...
                                <p>
                                    Complete our detailed assessment about your
                                    lifestyle habits
                                </p>
                            </div>
                        </div>
                        <div className="mr-6 flex items-start bg-gradient-to-r from-blue-900/20 to-gray-500/20 p-6 rounded-2xl backdrop-blur-sm shadow-lg">
                            ...
                            <div>
                                ...
                                <p>
                                    see the sarcastic result from anything in
                                    your life
                                </p>
                            </div>
                        </div>
                        <div className="flex mr-6 rounded-2xl items-center bg-gradient-to-r from-blue-900/20 to-gray-500/20 p-6 backdrop-blur-sm shadow-lg">
                            ...
                            <div>
                                ...
                                <p>
                                    Monitor changes, update your information,
                                    save your history.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="flex justify-center items-center flex-col space-y-6">
                                ...
                                <div className="p-6 rounded-2xl bg-gradient-to-r from-blue-900/20 to-gray-400/20">
                                    ...
                                    <p className="text-white italic">
                                        Oh wow, look at you, a true pioneer of
                                        modern laziness! Your diet is basically
                                        a science experiment gone wrong, and
                                        your workout routine? Yeah, blinking
                                        doesnt count as cardio. With sleep
                                        patterns that scream I have no idea what
                                        circadian rhythm means, your body is
                                        basically running on spite and caffeine
                                        at this point. But hey, who needs
                                        longevity when you can have instant
                                        gratification and chronic fatigue? Keep
                                        going like this, and your body might
                                        just file for early retirement. But
                                        if—just if—you dont want your heart
                                        giving up on you like an old iPhone
                                        battery, maybe try something radical,
                                        like drinking actual water or walking
                                        further than the distance from your
                                        couch to the fridge. Just a thought.
                                    </p>
                                </div>
                                <div className="p-6 rounded-2xl bg-gradient-to-r from-blue-900/20 to-gray-400/20">
                                    <div className="flex items-center mb-4">
                                    ...
                                    <p className="text-white italic">
                                        Hey, no judgment, but your body might
                                        appreciate a little more love. Right
                                        now, its running on low fuel, bad sleep,
                                        and some questionable food choices,
                                        which might not be the best long-term
                                        strategy. The good news? Small
                                        tweaks—like drinking more water, getting
                                        a little movement in, and not treating
                                        sleep like an optional side quest—can
                                        make a huge difference. No need to
                                        overhaul everything overnight, just
                                        start somewhere! Your future self will
                                        be very grateful.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-start gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-lg">
                                    ...
                                    assessments based on statistical models and
                                    data analytics. These predictions are not
                                    guaranteed and should not replace
                                    professional medical, financial, or legal
                                    advice. Always consult with qualified
                        ...
                        <div className="flex flex-col sm:flex-row items-start gap-6">
                            ...
                            <div>
                                ...
                                <p>
                                    ...
                                    seriously. All personal data is encrypted
                                    and stored securely.
                                </p>
                            </div>
                        </div>
